...
exports.window = exports.assignableWindow = exports.userAgent = exports.CompressionStream = exports.AbortController = exports.XMLHttpRequest = exports.fetch = exports.location = exports.document = exports.navigator = void 0;
/*
...
exports.CompressionStream = global === null || global === void 0 ? void 0 : global.CompressionStream;
