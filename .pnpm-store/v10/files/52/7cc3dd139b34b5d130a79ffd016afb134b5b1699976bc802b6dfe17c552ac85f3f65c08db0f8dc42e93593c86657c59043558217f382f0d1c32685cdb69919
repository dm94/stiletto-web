...
var BOT_REFUSE_MSG = 'Refusing to render web experiment since the viewer is a likely bot';
...
var WebExperiments = /** @class */ (function () {
    ...
    Object.defineProperty(WebExperiments.prototype, "_config", {
        get: function () {
    ...
    WebExperiments.prototype.initialize = function () { };
    ...
    WebExperiments.prototype.getWebExperiments = function (callback, forceReload, previewing) {
        ...
        this._instance._send_request({
            url: this._instance.requestRouter.endpointFor('api', "/api/web_experiments/?token=".concat(this._config.token)),
            method: 'GET',
    ...
    WebExperiments.prototype._is_bot = function () {
        if (globals_1.navigator && this._instance) {
            return (0, blocked_uas_1.isLikelyBot)(globals_1.navigator, this._config.custom_blocked_useragents);
        }
        else {
            return undefined;
        }
