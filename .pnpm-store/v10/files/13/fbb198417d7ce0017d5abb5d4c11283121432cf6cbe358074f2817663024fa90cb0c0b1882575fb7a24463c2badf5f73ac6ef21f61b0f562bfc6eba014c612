...
var LazyLoadedSessionRecording = /** @class */ (function () {
    ...
    LazyLoadedSessionRecording.prototype._activateTrigger = function (triggerType, matchDetail) {
        ...
        if (this._triggerMatching.triggerStatus(this.sessionId) === triggerMatching_1.TRIGGER_PENDING) {
            ...
            try {
                ...
                (_d = (_c = this._instance) === null || _c === void 0 ? void 0 : _c.persistence) === null || _d === void 0 ? void 0 : _d.register((_a = {},
                    _a[triggerType === 'url'
    ...
    LazyLoadedSessionRecording.prototype.onRRwebEmit = function (rawEvent) {
        ...
        this._urlTriggerMatching.checkUrlTriggerConditions(function () { return _this._pauseRecording(); }, function () { return _this._resumeRecording(); }, function (triggerType, matchDetail) { return _this._activateTrigger(triggerType, matchDetail); }, this.sessionId);
        ...
        var _l = ((_h = this._instance.config.session_recording.compress_events) !== null && _h !== void 0 ? _h : true)
            ? compressEvent(event)
    ...
    LazyLoadedSessionRecording.prototype._addEventTriggerListener = function () {
        ...
        this._removeEventTriggerCaptureHook = this._instance.on('eventCaptured', function (event) {
            ...
            // so we catch all errors.
            try {
                _this._eventTriggerMatching.checkEventTriggerConditions(event.event, function (triggerType, matchDetail) { return _this._activateTrigger(triggerType, matchDetail); }, _this.sessionId);
            }
            catch (e) {
