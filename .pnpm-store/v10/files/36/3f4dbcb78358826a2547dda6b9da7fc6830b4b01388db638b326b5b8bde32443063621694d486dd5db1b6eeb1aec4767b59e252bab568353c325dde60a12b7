...
exports.sessionStore = exports.resetSessionStorageSupported = exports.memoryStore = exports.createLocalPlusCookieStore = exports.localStore = exports.resetLocalStorageSupported = exports.cookieStore = exports.resetSubDomainCache = void 0;
...
var COOKIE_PERSISTED_PROPERTIES = [
    ...
    constants_1.USER_STATE,
];
/**
 * Creates a localPlusCookieStore instance with custom cookie-persisted properties
 */
var createLocalPlusCookieStore = function (customCookieProperties) {
    if (customCookieProperties === void 0) { customCookieProperties = []; }
    var cookiePropertiesToPersist = __spreadArray(__spreadArray([], __read(COOKIE_PERSISTED_PROPERTIES), false), __read(customCookieProperties), false);
    return __assign(__assign({}, exports.localStore), { _parse: function (name) {
            try {
            ...
            try {
                ...
                cookiePropertiesToPersist.forEach(function (key) {
                    if (value[key]) {
...
exports.createLocalPlusCookieStore = createLocalPlusCookieStore;
var memoryStorage = {};
