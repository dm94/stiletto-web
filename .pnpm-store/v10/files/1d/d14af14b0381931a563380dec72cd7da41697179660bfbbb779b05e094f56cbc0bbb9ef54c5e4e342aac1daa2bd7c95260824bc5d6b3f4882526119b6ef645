...
var ExceptionObserver = /** @class */ (function () {
    ...
    ExceptionObserver.prototype.startIfEnabledOrStop = function () {
        if (this.isEnabled) {
            logger.info('enabled');
            this._stopCapturing();
    ...
    ExceptionObserver.prototype.onConfigChange = function () {
        this._config = this._requiredConfig();
    };
    ExceptionObserver.prototype.captureException = function (errorProperties) {
        ...
        (_d = this._instance.exceptions) === null || _d === void 0 ? void 0 : _d.sendExceptionEvent(errorProperties);
    };
