  ...
  const getResourceEstimatedQuality = useCallback(() => {
    ...
    return (
      <div className="resource-quality-info bg-gray-800/30 p-3 rounded-md shadow-inner">
        <button
          type="button"
          className="w-full p-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 mb-3 font-medium transition-all duration-200 transform hover:-translate-y-px shadow-md"
          onClick={() =>
            updateResource?.(
              resource.mapid,
              resource.resourceid,
    ...
    <div className="resource-popup p-4 bg-gray-900 rounded-lg shadow-lg border border-gray-700 max-w-sm">
      ...
      <div className="resource-actions flex flex-col gap-2">
        {resource.token && (
          <button
            type="button"
            className="w-full p-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all duration-200 transform hover:-translate-y-px font-medium shadow-md"
