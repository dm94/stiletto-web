...
const getFactorName = (type: string, category: string): string | null => {
    ...
    case 'durability':
      switch (category) {
        ...
        case 'Armor':
          ...
          break;
        case 'Tool':
          factorName = 'ToolDurabilityFactor';
          break;
        default:
          break;
      }
...
const sumCalcs = (factorName: string, rarity: string, value: number): string => {
  let newValue = value;
